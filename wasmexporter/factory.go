...
func createTraces(
	...
	wasmExporter, err := newWasmTracesExporter(ctx, cfg.(*Config), set.TelemetrySettings)
	if err != nil {
		return nil, err
	}
...
func createMetrics(
	...
	wasmExporter, err := newWasmMetricsExporter(ctx, cfg.(*Config), set.TelemetrySettings)
	if err != nil {
		return nil, err
	}
...
func createLogs(
	...
	wasmExporter, err := newWasmLogsExporter(ctx, cfg.(*Config), set.TelemetrySettings)
	if err != nil {
		return nil, err
	}
