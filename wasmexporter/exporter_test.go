...
func TestExportTracesWithNopExporter(t *testing.T) {
	...
	cfg.Path = "testdata/nop/main.wasm"
	ctx := t.Context()
	wasmExp, err := newWasmTracesExporter(ctx, cfg, componenttest.NewNopTelemetrySettings().Logger)
	if err != nil {
		t.Fatalf("failed to create wasm traces exporter: %v", err)
	}
...
func TestExportMetricsWithNopExporter(t *testing.T) {
	...
	cfg.Path = "testdata/nop/main.wasm"
	ctx := t.Context()
	wasmExp, err := newWasmMetricsExporter(ctx, cfg, componenttest.NewNopTelemetrySettings().Logger)
	if err != nil {
		t.Fatalf("failed to create wasm metrics exporter: %v", err)
	}
...
func TestExportLogsWithNopExporter(t *testing.T) {
	...
	cfg.Path = "testdata/nop/main.wasm"
	ctx := t.Context()
	wasmExp, err := newWasmLogsExporter(ctx, cfg, componenttest.NewNopTelemetrySettings().Logger)
	if err != nil {
		t.Fatalf("failed to create wasm logs exporter: %v", err)
	}
