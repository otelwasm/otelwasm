...
import (
	...
	"github.com/otelwasm/otelwasm/examples/exporter/otlphttpexporter/otlphttpexporter/internal/metadata"
...
func createTraces(
	...
	println("createTraces URL: ", oce.tracesURL)
