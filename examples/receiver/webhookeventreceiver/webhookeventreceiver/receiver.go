...
func (er *eventReceiver) handleHealthCheck(w http.ResponseWriter, _ *http.Request, _ httprouter.Params) {
	...
	/*
		...
		github.com/otelwasm/otelwasm/examples/receiver/webhookeventreceiver/webhookeventreceiver.(*eventReceiver).handleHealthCheck(0x1477040, {0x3501d0, 0x14587e0}, 0x1566000, {0x0, 0x0, 0x0})
		...
		github.com/otelwasm/otelwasm/examples/receiver/webhookeventreceiver/webhookeventreceiver.(*eventReceiver).handleHealthCheck-fm({0x3501d0, 0x14587e0}, 0x1566000, {0x0, 0x0, 0x0})
		...
		github.com/otelwasm/otelwasm/examples/receiver/webhookeventreceiver/webhookeventreceiver.(*eventReceiver).Start.maxRequestBodySizeInterceptor.func2({0x3501d0, 0x14587e0}, 0x1566000)
		...
		github.com/otelwasm/otelwasm/examples/receiver/webhookeventreceiver/webhookeventreceiver.(*clientInfoHandler).ServeHTTP(0x140aba0, {0x34f2f8, 0x14e80e0}, 0x14edcc0)
		...
		github.com/otelwasm/otelwasm/guest/logsreceiver._startLogsReceiver()
